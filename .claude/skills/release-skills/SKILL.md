...
**Example Commits**:
```bash
git commit -m "feat(jackyshen-cover-image): add watercolor and minimalist styles"
git commit -m "fix(jackyshen-comic): improve panel layout for long dialogues"
...
```
Commits created:
  1. feat(jackyshen-cover-image): add watercolor and minimalist styles
  2. fix(jackyshen-comic): improve panel layout for long dialogues
...
Changes grouped by skill/module:
  jackyshen-cover-image:
    ...
    → Commit: feat(jackyshen-cover-image): add watercolor and minimalist styles
    → README updates: options table

  jackyshen-comic:
    - fix: panel layout for long dialogues
    → Commit: fix(jackyshen-comic): improve panel layout for long dialogues
    → No README updates
